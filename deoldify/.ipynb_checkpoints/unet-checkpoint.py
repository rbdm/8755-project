...
class UnetBlockWide(nn.Module):
    ...
    def forward(self, up_in: Tensor) -> Tensor:
        ...
        #print("UnetBlockWide shape:", up_in.shape)
        #plt.imshow(up_in.permute(1, 2, 0))
...
class DynamicUnetWide(SequentialEx):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(*layers)
        #under sfs_szs
        #print(len(sfs_szs), "len of sfs_szs") # sizes at different layers at Unet upsampling e.g. for 8 len of sfs_szs:
        ...
        #print(sfs_szs)
        #print(sfs_szs.size())
        #plt.imshow(sfs_szs.permute(1, 2, 0))
